...
/** Every command and query handler looks like this, policy included. */
...
/**
 * Boot-time registry. A handler without a declared policy cannot be registered,
 * so the module fails to boot rather than serving an unguarded command (F36).
 */
